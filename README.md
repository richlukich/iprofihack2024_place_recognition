# Хакатон "Мультикамерное распознавание места"

Данный репозиторий содержит базовое решение и вспомогательные скрипты для задачи "Мультикамерное распознавание места" хакатона образовательного форума по искусственному интеллекту, математике и физике 2024.
